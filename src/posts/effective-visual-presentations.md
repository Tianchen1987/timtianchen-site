---
title: "Effective visual presentations"
date: 2015-03-31
categories:
  - "Research"
...
To the 99 percenters, visual presentation amounts to powerpoint slides. Some may refer to them as a deck of powerpoint slides, as frustrating as such a name sounds.

I am not saying powerpoint is bad, in fact it is probably necessary when trying to elucidate your ideas. What is bad is using the features offered by powerpoint or Prezi (which is far worse when used for actual presentations where you are supposed to be the center of attention).
...
We often look at visually pleasing ppts and despair thinking that we can never make our slides look as nice. Not knowing that these visually pleasing ppts have no content, they are made to demonstrate the visual aspects of slides, and not to present any real ideas.
